...
function Login() {
    ...
    return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-teal-100 to-emerald-100 py-12 px-4 sm:px-6 lg:px-8">
        <div className={`mx-auto w-full max-w-lg bg-white rounded-2xl p-12 shadow-xl border border-emerald-200/50 backdrop-blur-sm`}>
            ...
            {error && <p className="text-red-600 mb-8 text-center font-medium bg-red-50 py-3 px-4 rounded-lg">{error}</p>}
